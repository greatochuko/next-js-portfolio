...
export default function MyExpertArea() {
  return (
    <div className="bg-white flex flex-col gap-2 text-zinc-800 rounded-xl shadow-[0_1px_5px_0px] shadow-zinc-300 min-h-80 p-5">
      ...
      <div className="grid flex-1 grid-cols-3 grid-rows-2 gap-3">
        {tools.map((tool) => (
          <div className="flex flex-col gap-1" key={tool.name}>
            <div className="bg-zinc-100 flex-1 rounded-lg"></div>
